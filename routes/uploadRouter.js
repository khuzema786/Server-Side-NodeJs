...
.post(cors.corsWithOptions, authenticate.verifyUser, authenticate.verifyAdmin, upload.single('imageFile'), (req, res) => {  // Note imagefile is the name used in multipart form at the client side
    res.statusCode = 200;
